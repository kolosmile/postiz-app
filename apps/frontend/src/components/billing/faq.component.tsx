      ...
      ? [
          {
            ...
            description: t(
              ...
              'To confirm credit card information socialhub will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      ...
      description: t(
        ...
        `${
          ...
          'socialhub'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/kolosmile/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
